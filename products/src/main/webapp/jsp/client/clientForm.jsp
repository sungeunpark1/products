			...
			<div class=content>
				<div class=login_wrap>
					<div class=login_form>
						<div class=login_box>
							<div class="find_mem_ttl">顧客登録</div>
							<form method="post" action=clientAction.jsp>
								...
								<div class=input_password>
									...
									%>
    									...
    									<select id="cproduct" name="cproduct" class="stockDetail_wrap_head_btn_select input" ">
								...
								<div class=input_password>
									<input class=input autocomplete="off" type="text" name=cname id="cname" placeholder="顧客名">
								</div>
								<div class=input_password>
									<input class=input autocomplete="off" type="text" name=cphonenumber id="cphonenumber" placeholder="お客様の電話番号">
								</div>
								<div class=input_password>
									<input class=input autocomplete="off" type="text" name=casdate id="casdate" placeholder="AS期間">
								</div>
								<div class=input_password>
									<input class=input autocomplete="off" type="text" name=cnote id="cnote" placeholder="備考">
								</div>
