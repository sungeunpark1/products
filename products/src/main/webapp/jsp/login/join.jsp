			...
			<div class=content>
				<div class=login_wrap>
					<div class=login_form>
						<div class=login_box>
							<div class="find_mem_ttl">会員登録</div>
							<form method="post" action=joinAction.jsp>
								...
								<div class=input_password>
									<input class=input autocomplete="off" type="text" name="userphonenumber" id="userphonenumber" placeholder="phone">
								</div>
								...
								<div class="grade_wrap">	
									...
									<label class="grade">
										<input type="radio" name="usergrade"  value="0"/>
									</label>
									<div class="grade">
										master
									</div>
									<label class="grade">
										<input type="radio" name="usergrade"  value="1"/>
									</label>
								</div>
